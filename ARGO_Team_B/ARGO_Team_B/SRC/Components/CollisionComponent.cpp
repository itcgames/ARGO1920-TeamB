...
void CollisionComponent::updateCollider(Entity& t_entity, double angle)
{
	...
	//::cout << "Position1 x: " << m_polyCollider.verts[0].x << "Position1 y: " << m_polyCollider.verts[0].y << std::endl;
	...
	//::cout << "Position3 x: " << m_polyCollider.verts[2].x << "Position3 y: " << m_polyCollider.verts[2].y << std::endl;
